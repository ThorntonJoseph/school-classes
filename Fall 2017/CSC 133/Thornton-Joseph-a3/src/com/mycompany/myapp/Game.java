...
public class Game extends Form implements ActionListener,Runnable{
	...
	private MyButton expand;
	private MyButton score;
	private MyButton up;
	private MyButton down;
	private MyButton teleportas;
	private MyButton contract;
	private MyButton right;
	private MyButton left;
	private MyButton teleportal;
	private MyButton heal;
	public Game() {
		gw = new GameWorld();
		sv = new ScoreView(gw);
	...
	public void run() {
		...
		if(gw.gameover()) {
			WinGame wg = new WinGame(gw,this);
